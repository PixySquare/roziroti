  ...
  return (
    <div className={styles.container}>
      <div className={styles.imageLogoDiv}>
        <Image src={FooterSection.logo} height="300px" width="300px" alt={"logo image"} />
      </div>
        ...
        <div className={styles.flexDiv}>
          <div className={styles.info}>
            <div>
              ...
              <p>{FooterSection.mail}</p>
            <div>
              <p>{FooterSection.owner.name} - {FooterSection.owner.name}</p>
              <p>{FooterSection.manager.name} - {FooterSection.manager.name}</p>
            </div>
          </div>
